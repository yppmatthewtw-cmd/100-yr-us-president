/* R4 — same anchored 3-pane layout as R3, but the Easy/Hard index and zone are
   re-derived from the COMBINED (A∩B∩C) 3-engine consensus.
...
(function () {
  ...
  function drawPane1() {
    ...
    var cr = el("line", { x1: 0, y1: mT, x2: 0, y2: vy + vh, stroke: "#fff", "stroke-width": 1, opacity: 0 });
